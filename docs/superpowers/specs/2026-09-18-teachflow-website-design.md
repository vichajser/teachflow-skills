...
2. **直接购买** —— 邮件 `vichajser@gmail.com`，人工开票与交付
...
**已采用方案（用户 2026-09-18 确认）**：`/pricing` 明确区分两条购买路径——经 Agensi 购买，或直接联系 `vichajser@gmail.com` 购买；`/legal/refund` 对直销路径给出本站自己的 14 天条款。本站 Stripe 账户对应的即为直销收款。此方案不扩大本期"仅做展示"的范围。
